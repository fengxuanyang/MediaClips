...
public class CenterSnapHelper extends SnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX,
        ...
        LogUtils.d(TAG, "findTargetSnapPosition currentView： " + currentView);
        ...
        LogUtils.d(TAG, "targetPos:" + targetPos);
        return targetPos;
    }

    @Override
    public View findSnapView(RecyclerView.LayoutManager layoutManager) {
        LogUtils.d(TAG, "findSnapView");
        View view = null;
        if (layoutManager.canScrollVertically()) {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager,
        ...
        LogUtils.d(TAG, "estimateNextPositionDiffForFling   ： " + (int) Math.round(distance / distancePerChild));
